...
Axion cloud around a compact object with a prescribed rotating dipole
electromagnetic background.

Run with:

    python examples/run_rotating_dipole_axion_2d.py
"""
...
def main() -> None:
    output_dir = ensure_output_dir(Path("outputs") / "phase17_rotating_dipole_axion_2d")
    ...
    print(
        plot_background_B_quiver_2d(
            ...
            t=0.0,
            output_dir=output_dir,
            filename="background_B_quiver_t0.png",
            stride=10,
        )
    )
    ...
    print(
        plot_background_EdotB_2d(
            ...
            t=0.0,
            output_dir=output_dir,
            filename="background_EdotB_t0.png",
        )
    )
    ...
    print(
        plot_background_B_magnitude_2d(
            ...
            t=numerics.t_final,
            output_dir=output_dir,
            filename="background_B_magnitude_final.png",
        )
    )
    ...
    print(
        plot_background_B_quiver_2d(
            ...
            t=numerics.t_final,
            output_dir=output_dir,
            filename="background_B_quiver_final.png",
            stride=10,
        )
    )
    ...
    print(
        plot_background_EdotB_2d(
            ...
            t=numerics.t_final,
            output_dir=output_dir,
            filename="background_EdotB_final.png",
        )
    )
